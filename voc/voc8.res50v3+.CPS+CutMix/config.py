...
if os.getenv('snapshot_dir'):
    ...
    C.snapshot_dir = '/farm/chenrui/code/TorchSemiSeg2/AAA_voc_8_epo34_cutmix_final/snapshot/snapshot/'
...
C.val_log_soft_file = C.log_dir + '/val_soft_' + exp_time + '.log'
C.link_val_log_soft_file = C.log_dir + '/val_soft_last.log'

""" Data Dir and Weight Dir """
# C.dataset_path = osp.join(C.volna, 'DATA/pascal_voc')
C.dataset_path = '/data/TorchSemiSeg2/DATA/pascal_voc'
C.img_root_folder = C.dataset_path
C.gt_root_folder = C.dataset_path
# C.pretrained_model = C.volna + 'DATA/pytorch-weight/resnet50_v1c.pth'
C.pretrained_model = '/data/TorchSemiSeg2/DATA/pytorch-weight/resnet50_v1c.pth'
...
''' Experiments Setting '''
# if os.getenv('labeled_ratio') is not None:
#     C.labeled_ratio = os.environ['labeled_ratio']
# else:
#     C.labeled_ratio = 16 # the path to the data dir.
...
if os.getenv('eval_save_path'):
    C.eval_save_path = os.environ['eval_save_path']
else:
    C.eval_save_path =  "/home/chenrui/code/TorchSemiSeg2/AAA_voc_2_epo60_cutmix_eval/results"

if os.getenv('eval_softvoting_save_path'):
    C.eval_softvoting_save_path = os.environ['eval_softvoting_save_path']
else:
    C.eval_softvoting_save_path =  "/home/chenrui/code/TorchSemiSeg2/AAA_voc_2_epo60_cutmix_eval/results_soft"
